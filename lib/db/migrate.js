...
exports.createDatabase = function() {
  return db()
  .then(function(r) {
    return db.qcollect(r.dbCreate(db.config.database).run());
  });
};
...
exports.tableList = function() {
  return db()
  .then(function(r) {
    return db.qcollect(r.db(db.config.database).tableList().run());
  });
};
...
exports.createSchemaMigrationsTable = function() {
  return db()
  .then(function(r) {
    return db.qcollect(r.db(db.config.database).tableCreate({
